            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <ul class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="" class="menu-link">
                                <div data-i18n="Notifications">Liste Consultants</div>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="menu-header small text-uppercase">
                    <span class="menu-header-text">Consultations</span>
                </li>
                <li class="menu-item">
                    <ul class="menu-item">
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="" class="menu-link">
                                <div data-i18n="Account">Calendrier</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="" class="menu-link">
                                <div data-i18n="Account">Tarifs</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Authentications">Régles de gestion</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="auth-login-basic.html" class="menu-link" target="_blank">
                                <div data-i18n="Basic">Unités</div>
                            </a>
                        </li>
                    </ul>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="auth-login-basic.html" class="menu-link" target="_blank">
                                <div data-i18n="Basic">Spécialités</div>
                            </a>
                        </li>
                    </ul>
                </li>
